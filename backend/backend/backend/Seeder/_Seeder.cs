    ...
    public static class Seeder
    {
        public static void Seed(DbContext context)
        {
            if (!context.Set<Category>().Any() && !context.Set<ProductImage>().Any() && !context.Set<Product>().Any())
            {
                ...
                Category diabloCollection = new Category { Name = "Diablo Bootleg Collection" };
                Category highHeavens = new Category { Name = "High Heavens" };
                Category burningHells = new Category { Name = "Burning Hells" };
                Category nephalem = new Category { Name = "Nephalem" };

                context.Set<Category>().AddRange([pikaCollection, toys, batBoyCollection, superHero, superVillain, starFightersCollection, starShip, cars, diabloCollection, highHeavens, burningHells, nephalem]);
                ...
                ProductImage demonLordImage0 = new ProductImage { ImageAlt = "Image de produit 1: Demon Lord-Chu", Order = 0, ImageData = GetImageFromFile("demon-lord-chu-0.png"), ContentType = "image/png" };
                ProductImage demonLordImage1 = new ProductImage { ImageAlt = "Image de produit 2: Demon Lord-Chu", Order = 1, ImageData = GetImageFromFile("demon-lord-chu-1.png"), ContentType = "image/png" };
                ProductImage archangelImage0 = new ProductImage { ImageAlt = "Image de produit 1: Archangel-Chu", Order = 0, ImageData = GetImageFromFile("archangal-chu-0.png"), ContentType = "image/png" };
                ProductImage archangelImage1 = new ProductImage { ImageAlt = "Image de produit 2: Archangel-Chu", Order = 1, ImageData = GetImageFromFile("archangal-chu-1.png"), ContentType = "image/png" };
                ProductImage deathSpeakerImage0 = new ProductImage { ImageAlt = "Image de produit 1: Death Speaker-Chu", Order = 0, ImageData = GetImageFromFile("death-speaker-chu-0.png"), ContentType = "image/png" };
                ProductImage deathSpeakerImage1 = new ProductImage { ImageAlt = "Image de produit 2: Death Speaker-Chu", Order = 1, ImageData = GetImageFromFile("death-speaker-chu-1.png"), ContentType = "image/png" };
                ProductImage lesserMummyImage0 = new ProductImage { ImageAlt = "Image de produit 1: Lesser Mummy-Chu", Order = 0, ImageData = GetImageFromFile("lesser-mummy-chu-0.png"), ContentType = "image/png" };
                ProductImage lesserMummyImage1 = new ProductImage { ImageAlt = "Image de produit 2: Lesser Mummy-Chu", Order = 1, ImageData = GetImageFromFile("lesser-mummy-chu-1.png"), ContentType = "image/png" };
                ProductImage goatmanImage0 = new ProductImage { ImageAlt = "Image de produit 1: Goatman-Chu", Order = 0, ImageData = GetImageFromFile("goatman-chu-0.png"), ContentType = "image/png" };
                ProductImage goatmanImage1 = new ProductImage { ImageAlt = "Image de produit 2: Goatman-Chu", Order = 1, ImageData = GetImageFromFile("goatman-chu-1.png"), ContentType = "image/png" };
                ProductImage skeletonKingImage0 = new ProductImage { ImageAlt = "Image de produit 1: Skeleton King-Chu", Order = 0, ImageData = GetImageFromFile("skeleton-king-chu-0.png"), ContentType = "image/png" };
                ProductImage skeletonKingImage1 = new ProductImage { ImageAlt = "Image de produit 2: Skeleton King-Chu", Order = 1, ImageData = GetImageFromFile("skeleton-king-chu-1.png"), ContentType = "image/png" };
                ProductImage primeEvilImage0 = new ProductImage { ImageAlt = "Image de produit 1: Prime Evil-Chu", Order = 0, ImageData = GetImageFromFile("prime-evil-chu-0.png"), ContentType = "image/png" };
                ProductImage primeEvilImage1 = new ProductImage { ImageAlt = "Image de produit 2: Prime Evil-Chu", Order = 1, ImageData = GetImageFromFile("prime-evil-chu-1.png"), ContentType = "image/png" };
                ProductImage boneWitchImage0 = new ProductImage { ImageAlt = "Image de produit 1: Bone Witch-Chu", Order = 0, ImageData = GetImageFromFile("bone-witch-chu-0.png"), ContentType = "image/png" };
                ProductImage boneWitchImage1 = new ProductImage { ImageAlt = "Image de produit 2: Bone Witch-Chu", Order = 1, ImageData = GetImageFromFile("bone-witch-chu-1.png"), ContentType = "image/png" };
                ProductImage horrorChiefImage0 = new ProductImage { ImageAlt = "Image de produit 1: Horror Chief-Chu", Order = 0, ImageData = GetImageFromFile("horror-chief-chu-0.png"), ContentType = "image/png" };
                ProductImage horrorChiefImage1 = new ProductImage { ImageAlt = "Image de produit 2: Horror Chief-Chu", Order = 1, ImageData = GetImageFromFile("horror-chief-chu-1.png"), ContentType = "image/png" };
                ProductImage bloodQueenImage0 = new ProductImage { ImageAlt = "Image de produit 1: Blood Queen-Chu", Order = 0, ImageData = GetImageFromFile("blood-queen-chu-0.png"), ContentType = "image/png" };
                ProductImage bloodQueenImage1 = new ProductImage { ImageAlt = "Image de produit 2: Blood Queen-Chu", Order = 1, ImageData = GetImageFromFile("blood-queen-chu-1.png"), ContentType = "image/png" };
                ...
                Product demonLord = new Product { Name = "Demon Lord", Description = "Le Seigneur Démon des Enfers, un ajout infernal et puissant à toute collection.", CreationDate = DateTime.Now, ModifyDate = DateTime.Now, Price = 34.99m, Categories = [toys, diabloCollection, burningHells], Status = ProductStatus.Available, UnitsInStock = 40, Images = [demonLordImage0, demonLordImage1] };
                Product archangel = new Product { Name = "Archangel", Description = "Un Archanges des Hauts Cieux, symbole de justice et de courage pour votre étagère.", CreationDate = DateTime.Now, ModifyDate = DateTime.Now, Price = 34.99m, Categories = [toys, diabloCollection, highHeavens], Status = ProductStatus.Available, UnitsInStock = 40, Images = [archangelImage0, archangelImage1] };
                Product deathSpeaker = new Product { Name = "Death Speaker", Description = "Ce moissonneur d'âmes est là pour garantir que votre collection ne manque pas de présence macabre.", CreationDate = DateTime.Now, ModifyDate = DateTime.Now, Price = 29.99m, Categories = [toys, diabloCollection, burningHells], Status = ProductStatus.Available, UnitsInStock = 60, Images = [deathSpeakerImage0, deathSpeakerImage1] };
                Product lesserMummy = new Product { Name = "Lesser Mummy", Description = "Une momie mineure, un vestige des temps anciens, pour les fans des créatures mortes-vivantes.", CreationDate = DateTime.Now, ModifyDate = DateTime.Now, Price = 24.99m, Categories = [toys, diabloCollection], Status = ProductStatus.Available, UnitsInStock = 50, Images = [lesserMummyImage0, lesserMummyImage1] };
                Product goatman = new Product { Name = "Goatman", Description = "Un Homme-chèvre barbare et féroce, armé d'un couperet, idéal pour les dioramas de combat.", CreationDate = DateTime.Now, ModifyDate = DateTime.Now, Price = 29.99m, Categories = [toys, diabloCollection], Status = ProductStatus.Available, UnitsInStock = 60, Images = [goatmanImage0, goatmanImage1] };
                Product skeletonKing = new Product { Name = "Skeleton King", Description = "Le Roi Squelette. Une figurine royale et terrifiante pour régner sur votre collection.", CreationDate = DateTime.Now, ModifyDate = DateTime.Now, Price = 34.99m, Categories = [toys, diabloCollection, burningHells], Status = ProductStatus.Available, UnitsInStock = 40, Images = [skeletonKingImage0, skeletonKingImage1] };
                Product primeEvil = new Product { Name = "Prime Evil", Description = "L'incarnation du Mal Premier. Un incontournable pour les collectionneurs de démons puissants.", CreationDate = DateTime.Now, ModifyDate = DateTime.Now, Price = 39.99m, DiscountPrice = 35.99m, Categories = [toys, diabloCollection, burningHells], Status = ProductStatus.Available, UnitsInStock = 30, Images = [primeEvilImage0, primeEvilImage1] };
                Product boneWitch = new Product { Name = "Bone Witch", Description = "Une sorcière nécromancienne maîtrisant les arts sombres, avec son bâton d'os luminescent.", CreationDate = DateTime.Now, ModifyDate = DateTime.Now, Price = 29.99m, Categories = [toys, diabloCollection, nephalem], Status = ProductStatus.Available, UnitsInStock = 55, Images = [boneWitchImage0, boneWitchImage1] };
                Product horrorChief = new Product { Name = "Horror Chief", Description = "Le Chef de l'Horreur, un guerrier barbare prêt à se jeter dans la bataille, haches à la main.", CreationDate = DateTime.Now, ModifyDate = DateTime.Now, Price = 34.99m, Categories = [toys, diabloCollection, nephalem], Status = ProductStatus.Available, UnitsInStock = 45, Images = [horrorChiefImage0, horrorChiefImage1] };
                Product bloodQueen = new Product { Name = "Blood Queen", Description = "La Reine de Sang. Une créature démoniaque élégante et mortelle pour compléter votre armée infernale.", CreationDate = DateTime.Now, ModifyDate = DateTime.Now, Price = 39.99m, Categories = [toys, diabloCollection, burningHells], Status = ProductStatus.Available, UnitsInStock = 30, Images = [bloodQueenImage0, bloodQueenImage1] };

                context.Set<Product>().AddRange([spiderChu, batChu, superChu, superGuy, evilGuy, cosmicBasilisk, golemKnigth, neoWyrm, starforgeExplorer, ironHauler, turboBlaze, texDinoco, boltRacer, skyhawkStreak, rustyHook, adventureHeroes, iceKing, pricessBubbleggum, marceline, lumpySpace, albusDumbodlre, harryPotter, hermioneGranger, ronWeasley, dracoMalfoy, demonLord, archangel, deathSpeaker, lesserMummy, goatman, skeletonKing, primeEvil, boneWitch, horrorChief, bloodQueen]);
                context.SaveChanges();
            }
        }
